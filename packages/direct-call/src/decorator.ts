...
import { CommunicationProtocol, ensureCorePluginsInitialized } from '@alexma03/utcp-sdk';
...
export function registerCallable(name: string, callable: Callable): void {
  ...
  if (protocol) {
    ...
    throw new Error('DirectCommunicationProtocol is not registered. Did you import @alexma03/utcp-direct-call?');
  }
}
