 ...
 * For direct text content, use @alexma03/utcp-text instead.
 */
// packages/file/src/file_communication_protocol.ts
import { promises as fs } from 'fs';
import * as path from 'path';
import * as yaml from 'js-yaml';
import { CommunicationProtocol, RegisterManualResult, CallTemplate, UtcpManual, UtcpManualSerializer, IUtcpClient } from '@alexma03/utcp-sdk';
