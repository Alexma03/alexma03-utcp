...
import { FileCommunicationProtocol, FileCallTemplate } from "@alexma03/utcp-file";
import "@alexma03/utcp-http"; // Needed for OpenAPI conversion
import { IUtcpClient, ApiKeyAuth } from "@alexma03/utcp-sdk";
